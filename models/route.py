...
class Route(models.Model):
    ...
    origin_id = fields.Many2one('routes.direction', string="Origin", required=True)
    destination_ids = fields.Many2many('routes.direction', string="Destinations", required=True)
    worker_id = fields.Many2one('routes.routeuser', string="Assigned to", required=True)
    author_id = fields.Many2one('routes.routeuser', string="Created by", required=True)
